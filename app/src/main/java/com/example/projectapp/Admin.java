...
public class Admin extends AppCompatActivity implements Adapter.OnNoteListener {
    ...
    public void onNoteClick(int position) {
        ...
        if( fAuth.getCurrentUser()!=null && fAuth.getCurrentUser().getEmail().equals("admin@gmail.com") ) {
            ...
            final Button btnCalendar=dialogView.findViewById(R.id.button4);
